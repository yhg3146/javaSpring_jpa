...
insert into book(`id`,`name`,`publisher_id`,`author_id`,`deleted`,`status`) values (1,'JPA 초격차 패키지',1,0,false,100);

insert into book(`id`,`name`,`publisher_id`,`author_id`,`deleted`,`status`) values (2,'Spring 초격차 패키지',1,0,false,200);

insert into book(`id`,`name`,`publisher_id`,`author_id`,`deleted`,`status`) values (3,'SpringBoot 패키지',1,0,true,100);

insert into review(`id`,`title`,`content`,`score`,`user_id`,`book_id`) values  (1,'내 인생을 바꾼 책','너무너무 좋았어요',5.0,1,1);
insert into review(`id`,`title`,`content`,`score`,`user_id`,`book_id`) values  (2,'너무 진도가 빨라요','너무너무 별로야',3.0,2,2);

insert into comment(`id`,`comment`,`review_id`) values  (1,'너무너무 좋았어요',1);
insert into comment(`id`,`comment`,`review_id`) values  (2,'저는 별로였는데요',1);
insert into comment(`id`,`comment`,`review_id`) values  (3,'저도 그냥 그랬어',2);